...
train_files = ["../txt/light_tab_dis_data_fb.txt",
                  ...
                  "../txt/light_tab_dis_data_toute_dir.txt"]
test_files = ["../txt/light_tab_dis_data_toute.txt",
              "../txt/light_tab_dis_data_diffax.txt"]
...
model = alternate_training(train_loaders, model, criterion, optimizer, num_epochs=50)
